...
Jako jádro pro komunikaci mezi telefonem a hrou slouží GraphQL subscription s názvem \uv{unityCommunication}. To potřebuje jako argument token s přihlášením, protože při navazování WebSocketu se nezasílá hlavička dotazu.\par
