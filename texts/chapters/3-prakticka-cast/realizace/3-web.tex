...
Celkový Frontend webové aplikace je navržen a řádně otestován softwarem \uv{Figma}. Prvním krokem je vytvoření celkového vzhledu a designu aplikace. Rozhraní musí být co nejvíce jednoduché a přehledné, jelikož je cíleno na mladší děti. Po navržení následovalo několik testů UX/UI. \uv{Figma} velice usnadní vývoj aplikace, protože jednotlivé části webu jsou navržené a celkové chování webu je nasimulované díky využitému prototypování, které \uv{Figma} nabízí. Z návrhu vychází kompletní vzhled a fungování webové aplikace.
