...
Před začátkem vyhodnocování je potřeba zkotrolovat zda všechny údaje sedí. Pro úspěšnou validaci je potřeba zaslat číslo ostrova a úrovně, čas ve kterém se začínalo řešit a fotografie kartiček. Pro zkontrolování integrity času je použit hash, kterému musí kontrolní součet. Kdyby ho uživatel nějak změnil nebyl by potom tento čas validní.
